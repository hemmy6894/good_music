        ...
        <div class="card border-left-success shadow py-2">
            <div class="card-body">
                ...
                <div class="col mr-2">
                    ...
                    <form disabled method="POST" action="{{ route('video.store') }}">
                        <fieldset {{ $disabled ?? ''}} >
                            @csrf
                            <div class="form-group">
                                <input type="video"  name="video" class="form-control form-control-user" id="exampleFirstvideo" placeholder="@lang('words.enter_video')">
                                @if($errors->has('video'))
